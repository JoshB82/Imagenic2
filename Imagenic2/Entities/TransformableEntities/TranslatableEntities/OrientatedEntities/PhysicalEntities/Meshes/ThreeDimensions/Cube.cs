...
public sealed class Cube : Mesh
{
    ...
    public Cube(Vector3D worldOrigin, Orientation worldOrientation, float sideLength) : base(worldOrigin, worldOrientation, MeshStructure.cuboidStructure.DeepCopy())
    {
