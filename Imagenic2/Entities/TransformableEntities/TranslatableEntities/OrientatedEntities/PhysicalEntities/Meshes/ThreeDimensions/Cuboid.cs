...
public class Cuboid : Mesh
{
    ...
    public Cuboid(Vector3D worldOrigin, Orientation worldOrientation, float length, float width, float height) : base(worldOrigin, worldOrientation, MeshStructure.cuboidStructure.DeepCopy())
    {
        Length = length;
        Width = width;
        Height = height;
